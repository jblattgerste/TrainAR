...
#### TrainAR Trainings:
- Vogel, K., Bernloehr, A., Willmeroth, T., Blattgerste, J., Hellmers, C., & Bauer, N. H. (2024). [Augmented reality simulation-based training for midwifery students and its impact on perceived knowledge, confidence and skills for managing critical incidents](https://doi.org/10.1016/j.midw.2024.104064). Midwifery, 136, 104064.
...
TrainAR recieved funding from multiple sources. It originated from and was initially funded by the project "Heb@AR - AR-Based-Training-Technology" [[1](https://mixality.de/hebar/)], grant 16DHB3021 by the German Ministry for Education and Research (BMBF), in which procedural Augmented Reality emergency trainings for academic midwifery education were explored. TrainAR is the abstraction and generalization of the interaction concepts, feedback mechanisms and didactic ideas developed there. Since the project ended in 2022, TrainAR was maintained by the Mixed Reality Lab at the University of Applied Sciences Emden/Leer. Since September 2026, it is partially funded by the "Educational Augmented Reality Authoring" (EDARA) [[2](https://mixality.de/edara/)] project through the European Union's Erasmus+ programme (grant agreement 2026-1-NO01-KA220-HED-000462029) and partially by ASTRA [[3](https://mixality.de/astra/)] through zukunft.niedersachsen, a joint funding program of the Lower Saxony Ministry of Science and Culture and the Volkswagen Foundation.
