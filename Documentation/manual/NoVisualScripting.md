...
This transition is hereby seamless and authors can create a basic flow using the Authoring Tool and then customize more in-depth object-level behaviours in the Unity Editor layout if necessary.
