...
Get a quick introduction to TrainAR and how to create a training in this 90-second video, then read on for the basic concepts behind the authoring tool.
